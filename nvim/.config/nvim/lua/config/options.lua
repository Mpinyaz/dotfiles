local options = {
	...
	winblend = 30,
	background = "dark",
	clipboard = { "unnamedplus", "unnamedplus" }, -- allows neovim to access the system clipboard
...
vim.opt.guifont = "Agave Nerd Font,FiraCode Nerd Font,Hack Nerd Font:h18" -- Font
